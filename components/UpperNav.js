...
const UpperNav = () => {
  return (
    <div
      className={`hidden lg:flex items-center justify-between py-8 ${styles.uppernavCon} ${styles.navContainer}`}
    >
      <div>
        <Link href={"/"}>
          <Image src={logo} alt="logo of the page" width={151} height={36} />
        </Link>
      </div>
      <div className={`${styles.formController} border min-w-[517px]`}>
        <input type="text" placeholder="Search Product..." />
        <select className="border-l" name="cars" id="cars">
          <option className="border border-l" defaultValue="volvo">
            All Categories
          </option>
        </select>
